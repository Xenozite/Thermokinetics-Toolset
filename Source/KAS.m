...
KASLeftSide{StageId}(TargetConversionId, VelocityId) = log(InitialVelocities(VelocityId)) - log(TargetConversionsTemperatures{VelocityId, StageId}(TargetConversionId) .^ 2);
end
end
