...
S2 = S2 + (InitialVelocities(j) .* I(SameConversionsTemperatures{StageId}(TargetConversionId, i), EaBuffer(EaId)) ./ (InitialVelocities(i) .* I(SameConversionsTemperatures{StageId}(TargetConversionId, j), EaBuffer(EaId))) - 1) .^ 2;
end
end
end
